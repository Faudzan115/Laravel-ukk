...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row" class="table-secondary">{{$produk->ProdukID}}</th>
      <td class="table-secondary">{{$produk->NamaProduk}}</td>
      <td class="table-secondary">{{$produk->Harga}}</td>
      <td class="table-secondary">{{$produk->Stok}}</td>
      <td class="table-secondary"><button type="button" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        <button type="button" class="btn btn-outline-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up" viewBox="0 0 16 16">
          ...
          <button type="button" class="btn btn-outline-primary"><a href="{{'data_produk'}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-text" viewBox="0 0 16 16">
