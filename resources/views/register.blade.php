        ...
        <nav class="navbar" style="background-color: 	#B8860B; backdrop-filter: blur(10px);">
            <div class="container">
                <a class="navbar-brand text-light fs-4" >
                    <img src="https://png.pngtree.com/png-clipart/20220910/original/pngtree-cashier-png-image_8525902.png" width="100px"
                        heigth="100px"> WebKasir
                </a>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <label class="form-label" for="form3Example1">Masukan ID :</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input id="input" type="text" id="form3Example2" class="form-control" name="nama"/>
                                            <label class="form-label" for="form3Example2">Masukan NamaLengkap Anda :</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <label class="form-label" for="form3Example1">Membuat ALAMAT :</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
